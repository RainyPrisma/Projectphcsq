...
<header class="gallery-header">
    <div class="dropdown">
        <button class="dropdown-btn">
            <h1>Any of Shell 🐚<span class="dropdown-arrow">▾</span></h1>
        </button>
        <div class="dropdown-content">
            ...
            <div class="dropdown-category">
                ...
                <a href="gallery.php" class="dropdown-item"><span class="icon">⭐</span>New Arrivals</a>
            </div>
        </div>
    </div>
